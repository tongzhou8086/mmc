...
// MXFP8 double-TMEM-buffering variant. The epilogue loads 128 accumulator
// columns into registers before draining two 64-column TMA store tiles. This
// frees the 72-column scale window after the first 128-column TMEM load.
