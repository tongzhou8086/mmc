...
//
// GROUP_SIZE_M=16 variant of bf16-single-ns2-store2-bk128-bn512-load256-w8-splitacc.cu. Only the CTA-swizzle
// chunk differs: clusters are walked 16 M-clusters deep per column group
