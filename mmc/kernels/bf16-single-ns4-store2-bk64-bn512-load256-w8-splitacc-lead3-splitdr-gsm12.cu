...
//
// Adapted from bf16-single-ns4-store2-bk64-bn512-load256-w8-splitacc-lead3.cu,
...
//
// GROUP_SIZE_M=12 variant of bf16-single-ns4-store2-bk64-bn512-load256-w8-splitacc-lead3-splitdr.cu. Only the CTA-swizzle chunk
