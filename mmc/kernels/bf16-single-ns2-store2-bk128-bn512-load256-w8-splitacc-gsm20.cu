...
//
// GROUP_SIZE_M=20 variant of bf16-single-ns2-store2-bk128-bn512-load256-w8-splitacc.cu. Only the CTA-swizzle
// chunk differs: clusters are walked 20 M-clusters deep per column group
// instead of 8, which changes the L2 reuse pattern and the order clusters
// retire in.
//
...
constexpr int GROUP_SIZE_M = 20;      // CTA-swizzle chunk (1 = no swizzle)
