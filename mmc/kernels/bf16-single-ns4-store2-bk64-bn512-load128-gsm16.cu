...
//
// GROUP_SIZE_M=16 variant of bf16-single-ns4-store2-bk64-bn512-load128.cu. Only the CTA-swizzle chunk
// differs: clusters are walked 16 M-clusters deep per column group instead
