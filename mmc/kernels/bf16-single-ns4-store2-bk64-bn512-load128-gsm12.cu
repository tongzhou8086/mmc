...
//
// GROUP_SIZE_M=12 variant of bf16-single-ns4-store2-bk64-bn512-load128.cu. Only the CTA-swizzle chunk
// differs: clusters are walked 12 M-clusters deep per column group instead
// of 8, which changes the L2 reuse pattern and the order clusters retire in.
//
