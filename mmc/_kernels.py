...
BF16_KERNELS = (
    ...
    KernelSpec(
        "bf16-double-ns6-store2-bk64-gsm12",
        64, 256, 230400, m_multiple=256, n_multiple=256,
    ),
    KernelSpec(
        "bf16-single-ns4-store2-bk64-bn512-gsm12",
        64, 256, 230400, m_multiple=256, n_multiple=512,
    ),
    KernelSpec(
        "bf16-single-ns4-store2-bk64-bn512-load128-gsm12",
        64, 256, 230400, m_multiple=256, n_multiple=512,
    ),
    KernelSpec(
        "bf16-single-ns4-store2-bk64-bn512-load256-w8-gsm12",
        64, 384, 230400, m_multiple=256, n_multiple=512,
    ),
    KernelSpec(
        "bf16-single-ns4-store2-bk64-bn512-load256-w8-splitacc-gsm12",
        64, 384, 230400, m_multiple=256, n_multiple=512,
    ),
    KernelSpec(
        "bf16-single-ns4-store2-bk64-bn512-load256-w8-splitacc-lead2-gsm12",
        64, 384, 230400, m_multiple=256, n_multiple=512,
    ),
    KernelSpec(
        "bf16-single-ns4-store2-bk64-bn512-load256-w8-splitacc-lead3-gsm12",
        64, 384, 230400, m_multiple=256, n_multiple=512,
    ),
    KernelSpec(
        "bf16-single-ns4-store2-bk64-bn512-load256-w8-splitacc-splitdr-gsm12",
        64, 384, 230400, m_multiple=256, n_multiple=512,
    ),
    KernelSpec(
        "bf16-single-ns4-store2-bk64-bn512-load256-w8-splitacc-lead2-splitdr-gsm12",
        64, 384, 230400, m_multiple=256, n_multiple=512,
    ),
    KernelSpec(
        "bf16-single-ns4-store2-bk64-bn512-load256-w8-splitacc-lead3-splitdr-gsm12",
        64, 384, 230400, m_multiple=256, n_multiple=512,
    ),
    KernelSpec(
        "bf16-double-ns6-store2-bk64-gsm16",
        64, 256, 230400, m_multiple=256, n_multiple=256,
    ),
    KernelSpec(
        "bf16-single-ns4-store2-bk64-bn512-gsm16",
        64, 256, 230400, m_multiple=256, n_multiple=512,
    ),
    KernelSpec(
        "bf16-single-ns4-store2-bk64-bn512-load128-gsm16",
        64, 256, 230400, m_multiple=256, n_multiple=512,
    ),
    KernelSpec(
        "bf16-single-ns4-store2-bk64-bn512-load256-w8-gsm16",
        64, 384, 230400, m_multiple=256, n_multiple=512,
    ),
    KernelSpec(
        "bf16-single-ns4-store2-bk64-bn512-load256-w8-splitacc-gsm16",
        64, 384, 230400, m_multiple=256, n_multiple=512,
    ),
    KernelSpec(
        "bf16-single-ns4-store2-bk64-bn512-load256-w8-splitacc-lead2-gsm16",
        64, 384, 230400, m_multiple=256, n_multiple=512,
    ),
    KernelSpec(
        "bf16-single-ns4-store2-bk64-bn512-load256-w8-splitacc-lead3-gsm16",
        64, 384, 230400, m_multiple=256, n_multiple=512,
    ),
    KernelSpec(
        "bf16-single-ns4-store2-bk64-bn512-load256-w8-splitacc-splitdr-gsm16",
        64, 384, 230400, m_multiple=256, n_multiple=512,
    ),
    KernelSpec(
        "bf16-single-ns4-store2-bk64-bn512-load256-w8-splitacc-lead2-splitdr-gsm16",
        64, 384, 230400, m_multiple=256, n_multiple=512,
    ),
    KernelSpec(
        "bf16-single-ns4-store2-bk64-bn512-load256-w8-splitacc-lead3-splitdr-gsm16",
        64, 384, 230400, m_multiple=256, n_multiple=512,
    ),
...
BF16_KERNEL_SET_VERSION = "sm100a-bf16-v9"
