...
本文以我们在 B200 上优化矩阵乘法的经历为基础，讲一个以“流水线编排”为核心的故事，一种从“算法设计”的视角来看待矩阵乘法 kernel 的编写。除流水线编排之外，我们只使用两种必备的常规优化 —— 2-CTA MMA 与 CTA swizzling —— 便能在 4096 及以上的方阵上接近乃至超越 cuBLAS。
...
![5 种操作及其源和目的 buffer](https://raw.githubusercontent.com/tongzhou8086/mmc/61277ba691ea9c3ac1eaa19f2b835f6537a3e906/data-flow-models/figures/operations-chain.png)
...
在 14336 以下，两种 BK 的差距基本都在 2% 以内，互有胜负 —— BK 加倍以后 TMA buffer 从 6 个掉到 3 个，run-ahead 变浅，恰好抵消掉更少更大的内存读取带来的好处。但从 16384 开始，BK=128 就明显占优了，到 20480 上快出 **14.0%**。值得注意的是真正在动的是 BK=64：它从 6144 上的 1394 一路掉到 20480 上的 1210，而 BK=128 从 8192 往后一直稳定在 1360 到 1390 之间。也就是说 BK=128 的优势不在于它自己变快，而在于它在大尺寸上不像 BK=64 那样掉下去。
