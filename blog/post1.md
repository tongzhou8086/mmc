...
![2-CTA MMA 开启前后：不开启时两个 CTA 各自都要完整的 B tile，B 被读两遍；开启后两个 CTA 合算一块 2BMxBN 的输出，B 被切成两半，只读一遍](https://github.com/user-attachments/assets/e80a51c8-aac1-45b0-991c-74ec8d791fce)
